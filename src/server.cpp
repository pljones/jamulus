...
CServer::CServer ( const int          iNewMaxNumChan,
    ...
    ServerListManager ( iPortNumber, strCentralServer, strServerListFileName, strServerInfo, strServerPublicIP, strServerListFilter, iNewMaxNumChan, &ConnLessProtocol ),
    JamController ( this ),
